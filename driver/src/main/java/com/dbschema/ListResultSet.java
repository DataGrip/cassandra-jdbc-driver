...
public class ListResultSet implements ResultSet {
  ...
  public ListResultSet(Object value, String columnName) {
  ...
  private void checkClosed() throws SQLException {
    if (isClosed) throw new SQLException(this.getClass().getSimpleName());
  }
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    ...
    if (columnNames != null) {
      for (String columnName : columnNames) {
        columnMetaData.add(new CassandraResultSetMetaData.ColumnMetaData(columnName, "", "", ""));
      }
    }
